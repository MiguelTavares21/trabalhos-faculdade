...
{
    /// <summary>
    /// Representa os dados de um utilizador dentro de um grupo, incluindo informações pessoais e o seu papel no grupo.
    /// </summary>
    public class userInGroupDto
    {
        /// <summary>
        /// Identificador único do utilizador dentro do sistema.
        /// </summary>
        ...
        /// <summary>
        /// Indica se o utilizador está a optar por receber notificações.
        ...
        /// <summary>
        /// Papel ou função do utilizador dentro do grupo.
        /// Este campo é obrigatório e deve ser um valor do tipo `Roles` (Admin ou Utilizador).
        /// </summary>
        [Required]
