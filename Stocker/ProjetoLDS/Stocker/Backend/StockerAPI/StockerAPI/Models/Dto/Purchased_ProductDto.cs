...
{
    /// <summary>
    /// Representa os dados de um produto comprado, incluindo o identificador do produto, nome, preço e quantidade.
    /// </summary>
    public class Purchased_ProductDto
    {
        /// <summary>
        ...
        /// <summary>
        /// Nome do produto.
        /// Este campo é obrigatório e deve conter o nome do produto comprado.
        /// </summary>
        [Required]
