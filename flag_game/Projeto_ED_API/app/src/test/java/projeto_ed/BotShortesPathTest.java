...
public class BotShortesPathTest {
    ...
    void testCreateRout() {
        ...
        BotShortestPath bot = new BotShortestPath("Bot1", Team.EQUIPA1);
    ...
    void testPlay() {
        ...
        BotShortestPath bot = new BotShortestPath("Bot1", Team.EQUIPA2);
        bot.createRout(map, startVertex, flagVertex);
    ...
    void testPlay2() {
        ...
        BotShortestPath bot = new BotShortestPath("Bot1", Team.EQUIPA2);
        BotShortestPath bot1 = new BotShortestPath("Bot2", Team.EQUIPA1);
        bot.createRout(map, startVertex, flagVertex);
